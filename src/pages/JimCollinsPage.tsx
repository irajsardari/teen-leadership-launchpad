      ...
      <article className="echoes-article">
        ...
        <header className="echoes-hero">
          <div className="echoes-hero-text">
            ...
            <blockquote className="echoes-quote">
              ...
              <span className="echoes-quote-attrib">— Jim Collins</span>
            </blockquote>
          </div>
        </header>
        ...
        <section className="echoes-section">
          ...
          <p className="echoes-paragraph text-sm text-muted-foreground mt-4">
            (Sources: Stanford Graduate School of Business; HarperCollins Publishers; Good to Great research database.)
          </p>
        </section>
        ...
        <section className="echoes-section">
          ...
          <ul className="echoes-list">
            <li><em>Built to Last</em> (1994, with Jerry Porras) — Examined visionary companies that thrived for generations.</li>
            <li><em>Good to Great</em> (2001) — Revealed the disciplines that transform good companies into great ones.</li>
            <li><em>How the Mighty Fall</em> (2009) — Analyzed the stages of organizational decline.</li>
            <li><em>Great by Choice</em> (2011, with Morten Hansen) — Studied how companies thrive in chaos and uncertainty.</li>
            <li><em>Beyond Entrepreneurship 2.0</em> (2020) — A practical guide for building an enduring great company.</li>
          </ul>
