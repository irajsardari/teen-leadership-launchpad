-- SECURITY FIX: Maximum Teacher Applications Data Protection
...
-- Admins can read all applications (but still subject to restrictive policies above)
...
-- Admins can modify all applications (but still subject to restrictive policies above)
CREATE POLICY "teacher_applications_admin_write"
ON public.teacher_applications
