-- Complete security improvements for parental_consents table - Fixed version
...
-- Drop constraints if they exist, then recreate
ALTER TABLE public.parental_consents 
DROP CONSTRAINT IF EXISTS parental_consents_valid_relationship;

ALTER TABLE public.parental_consents 
DROP CONSTRAINT IF EXISTS parental_consents_different_users;

ALTER TABLE public.parental_consents 
DROP CONSTRAINT IF EXISTS parental_consents_valid_email;

ALTER TABLE public.parental_consents 
DROP CONSTRAINT IF EXISTS parental_consents_unique_child_parent;
...
ALTER TABLE public.parental_consents 
ADD CONSTRAINT parental_consents_unique_child_parent 
